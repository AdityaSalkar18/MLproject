...
function Webad() {
    ...
    const handleClick = async () => {
        const data = { features };
        try {
            const response = await axios.post('http://localhost:5000/predict_model3', data);
        ...
        <>
            ...
            <div className='bg-dark p-4'>
                <div className='container'>
                    <h3 className='text-white text-center mt-5'>App After Deployment</h3>
                </div>
                <div className="container my-2">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb p-3 bg-body-dark rounded-3">

                            <li className="breadcrumb-item"><a href="/application" className="text-decoration-none">Inital</a></li>
                            <li className="breadcrumb-item"><a href="/appc" className="text-decoration-none">Current/(Working)</a></li>
                            <li className="breadcrumb-item active text-white" aria-current="page">After Deployment</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div className="container">
                    <div className="form-floating mb-3">
                        ...
                        />
                        <label htmlFor="Response Time (ms)">Response Time (ms)</label>
                    </div>
                    <div className="form-floating mb-3">
                        <input
                            type="number"
    ...
    <div className="row g-4 py-5 row-cols-1 row-cols-lg-3 border-top">
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h3 className=" text-white">Flutter</h3>
      ...
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h3 className="text-white">Xamarin</h3>
          <p className="text-secondary">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
          <a href="/" className="btn btn-primary">
            Open
          </a>
    ...
    <div className="row g-4 py-5 row-cols-1 row-cols-lg-3 ">
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h3 className=" text-white">Ionic</h3>
          <p className="text-secondary">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
          <a href="/" className="btn btn-primary">
           Open
          </a>
      ...
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h3 className=" text-white">NativeScript</h3>
          <p className="text-secondary">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
          <a href="/" className="btn btn-primary">
           Open
          </a>
      ...
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h3 className="text-white">Swiftic</h3>
          <p className="text-secondary">Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
          <a href="/" className="btn btn-primary">
           Open
          </a>
